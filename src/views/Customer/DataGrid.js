...
const DataGrid = (props) => {
  ...
  let header = [
    ...
    {
      title: <FormattedMessage id="Grid.email" defaultMessage="Email" />,
      dataIndex: "email",
      key: "email",
    },
    {
      title: <FormattedMessage id="Grid.phone" defaultMessage="Phone" />,
      dataIndex: "phone",
      key: "phone",
    },
    {
      title: <FormattedMessage id="Grid.object" defaultMessage="Object" />,
      dataIndex: "object",
      key: "object",
    },
    {
    ...
    {
      title: (
        <FormattedMessage id="Grid.createdAt" defaultMessage="createdAt" />
      ),
      dataIndex: "createdAt",
      key: "createdAt",
      render: (text) =>
        datetimeHelper.formatTimeStampToUtcTime(text, DEFAULT_FORMAT_DATE_SGN),
    },
    {
  ...
  return (
    <CustomTable
      ...
      onRowClick={(record) =>
        redirectPath(`${routes.ROUTE_CUSTOMERS_EDIT}/${record._id}`)
      }
    />
  );
};
